...
const SignUpCreatPage = () => {
  ...
  const validationSchema = Yup.object({
    first_name: Yup.string()
      .required(t<string>("validation_messages.first_name"))
      .min(2, t<string>("validation_messages.first_name_min")),
    last_name: Yup.string()
      .required(t<string>("validation_messages.last_name"))
      .min(2, t<string>("validation_messages.last_name_min")),
    email: Yup.string()
        ...
        <form onSubmit={handleSubmit}>
          ...
          <AuthInput
            ...
            placeholder={t<string>(
              "sign_up_create.password_confirmation_placeholder"
            )}
            ...
            error={
              ...
              (values.password !== values.password_confirmation
                ? t<string>("validation_messages.password_not_match")
                : "")
            }
...
const Container = styled(Grid)`
  ...
  flex-direction: ${(props: ContainerProps) =>
    props.flexDirection + " !important" || "initial"};
`;
const HeaderContainer = styled(Grid)`
  flex: 1;
  margin-top: ${(props: ContainerProps) =>
    props.marginTop + " !important" || "0"};
`;
