      ...
      en: {
        translation: {
          ...
          sign_up_create: {
            ...
            header_text:
              "Can't decide a place to eat? Create an account in <b style='color: #C34646'>Review</b>, then.",
          ...
          sign_in: {
            ...
            banner_text:
              "Welcome Back! You can find best restourants here, rate them",
      ...
      tr: {
        translation: {
          ...
          sign_up: {
            ...
            welcome_text:
              "En iyi restoranları bulabilir, veya puanlayabilirsiniz.",
            ...
            sign_up_response_error_message:
              "Bu email daha önceden kayıt edilmiş",
          },
          sign_up_create: {
            header_title: "Hazırsan Başlayalım!",
            header_text:
              "Nerede yiyeceğine karar veremedin mi? <b style='color: #C34646'>Review</b>'de bir hesap oluştur.",
          ...
          sign_in: {
            ...
            banner_text:
              "Hoşgeldiniz! Burada en iyi restoranları bulup, puanlayabilirsiniz",
